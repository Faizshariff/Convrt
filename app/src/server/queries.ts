import { type DailyStats, type GptResponse, type User, type PageViewSource, type Task, type File, type Campaign } from 'wasp/entities';
...
export const getCampaigns: GetCampaigns<any, Campaign[]> = async (_args, context) => {
  if (!context.user) {
